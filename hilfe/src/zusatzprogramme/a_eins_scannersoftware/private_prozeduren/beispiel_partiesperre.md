...
```sql
CREATE PROCEDURE p_partie_sperre (  in in_vklasse   integer,
                                         in in_vuklasse    integer,
...
BEGIN
   ...
   select partiesperrkennz into dc_partiesperrkenz  from partiestamm
      where Lagernummer = in_LagerNummer   and Partieid = in_partie;
