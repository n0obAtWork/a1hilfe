...
<?xml version="1.0" encoding="utf-8" standalone="yes"?>
 <Description Name="AW_FA_VIEW.VIEWDIALOG" RowHeight="22" Version="">
  ...
  <Field Name="Versand" Caption="Versand" Sql="(Select list(fv.Empfaenger||' '||fv.datum order by datum desc) from fa_versandhistorie fv
