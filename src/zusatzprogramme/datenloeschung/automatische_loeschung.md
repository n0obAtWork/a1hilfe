...
| Dl_LogVerzeichnis | Beinhaltet den Dateipfad, in welchem die Logdateien gespeichert werden sollen.<br>Ist der angegebene Pfad nicht vorhanden, so wird dieser automatisch angelegt. |
