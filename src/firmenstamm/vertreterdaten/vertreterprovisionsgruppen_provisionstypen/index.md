...
<!-- source: https://amic.de/hilfe/_vertreterprovisionsg.htm -->
...
8 = Provision mit variablen Mengenbezug

10 = Staffelung in max. 10 Provisionsberechnungen (siehe unten Provisionsstaffelung)

11 = Überschussprovision

20 = Staffelprovision Preis + Zu – und Abschläge

21 = Überschussprovision Preis + Zu – und Abschläge

101 = rohgewinnbezogene Provision Abrechnungstag

<p class="siehe-auch">Siehe auch:</p>

- [Vertreterprovisionsgruppen Variante 1](./vertreterprovisionsgruppen_variante_1.md)
- [Vertreterprovisionsgruppen: Pfleger](./vertreterprovisionsgruppen_pfleger.md)
