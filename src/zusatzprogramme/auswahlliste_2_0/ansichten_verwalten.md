...
| exportieren | Einmal erstellte Ansichten lassen sich Exportieren m sie in andere Systeme einspielen zu können. Zu einer so exportierten Ansicht gehören:<br>• Sortierung<br>• Farben<br>• Spalten<br>• SQL-Variablen<br>• Summen<br>• Alle für diese Ansicht erstellten Reporte. *Bei der Standardansicht werden nur die Reporte exportiert.*<br> <br>**Achtung:** <em>Die so exportierten Ansichten lassen sich nur im Ansichten-Manager über</em> <strong>*„import“*</strong> <em>wieder einlesen.</em><br> |
...
<strong>Achtung: *„*</strong><em>Freigabe für andere Benutzer“, „Rolle“ und „Tooltip“ werden erst beim Verlassen des Ansichten-Managers gespeichert. Aktionen, die über einen Button ausgelöst werden, werden sofort durchgeführt.</em>
