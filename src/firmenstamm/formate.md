...
| Aktiv | Hier wird entschieden, ob der Eintrag überhaupt angezeigt und verwendet werden soll.<br><ul><li>Ja = uneingeschränkt verwendbar</li><li>Nein = nicht verwendbar</li><li>Kann nur angezeigt, aber nicht ausgewählt werden. (z.B. um einen interims-Status anzuzeigen)</li></ul> |
