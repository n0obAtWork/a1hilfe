...
<!-- source: https://amic.de/hilfe/_IndividualpreiskalkulationExcel.htm -->
...
Voraussetzung für die Nutzung der Funktionen ist eine Excel-Individualpreiskalkulation-Lizenz.
...
- Der Steuerparameter **1167** ist aktiviert.
- Der Steuerparameter **508** ist aktiviert.
- Eine A.eins-Version ab **9.0.2601.1** ist installiert.

Der Import über die Anwendung **Individualpreiskalkulation Excel** setzt sich aus den folgenden Schritten zusammen:

- [Export konfigurieren](./export_konfigurieren.md)
- [Exportprofil einrichten](./exportprofil_einrichten.md)
- [Individualpreise exportieren](./individualpreise_exportieren.md)
- [Excel-Datei bearbeiten](./excel_datei_bearbeiten.md)
