...
| Typ | Wert |
| --- | --- |
| MENGEUEBER | Für die Anzeige ratierlicher Monatsmengen in der Standardauswahlliste des Kontraktstamm-Pflegemoduls wie auch bei der variablen Zeitraumwahl (Option „Variable Kontraktzeitraumzuordnung“) während der Warenpositionsbearbeitung eines Vorgangs gilt bei der Einstellung dieser Option mit dem Wert „Ja“:<br> Ist bei der Verteilung die gelieferte Menge größer als die ratierliche Menge des Monats, wird die Übermenge in den nächsten Monat übernommen.<br>Übermengen die über die Zeiträume hinausgehen, werden im speziellen Feld „UEBERMENGE“ in den jeweiligen Tabellen gespeichert.<br> |
