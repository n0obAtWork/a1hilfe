...
<!-- source: https://amic.de/hilfe/_erlskennzifferstamme.htm -->
...
• Ist beim Artikel eine Erlöskennziffer größer als (>) 0 eingetragen, so hat dieser Vorrang vor derjenigen im Artikelstamm (Beispiel: Erlöskonten je Lager)
