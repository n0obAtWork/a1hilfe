...
| --- | --- |
| Bild-Anzeige | Die Bild-Anzeige bietet im Kontext-Menü folgende Darstellungsarten. Diese werden sich sitzungsübergreifend für den jeweiligen A.eins-Benutzer gemerkt.  
   
• Dehnen  
Das Bild wird gestreckt oder verkleinert, damit es der Größe der Bild-Anzeige entspricht.  
• Originalgröße  
Das Bild wird in Original-Größe dargestellt. Ist das Bild größer als die Bild-Anzeige, dann wird die Bild-Anzeige mit Rollbalken ausgestattet.  
• Skalieren  
Das Bild wird unter Beibehaltung der Größenverhältnisse vergrößert oder verkleinert.  
 |
