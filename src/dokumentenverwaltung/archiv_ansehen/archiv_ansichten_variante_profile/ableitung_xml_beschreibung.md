...
| | RowHeight | Höhe einer Datenzeile in Pixel.  
(Standard bzw. Vorgabe ist 22) |
...
| | Mime | Standard: false  
Stellt den Mime-Typen (fa_mime) als Mini-Icon in der Spalte dar. |
| | Icon | Standard: false  
Wenn angegeben, dann sollte der zugehörige Wert über Sql einer der folgenden fest vorgegebenen Möglichkeiten sein: |
...
Damit lässt sich also eine Spalte „wegblenden“, der Wert wird aber ermittelt. |
| With | | Der Wert des Elements gibt die With-Erweiterung vor. |
| Limitation | | Der Wert des Elements gibt die Limitierung der Anzahl der Datensätze an.  
   
Beispiel: top 50 |
| From | | From-Klausel  
Standard:  
