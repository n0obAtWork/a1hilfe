...
<!-- source: https://amic.de/hilfe/_EXCLEI_EXCEL_IMPORT.htm -->
...
Für den Excel-Import ist keine Excel-Installation notwendig.

<p class="siehe-auch">Siehe auch:</p>

- [Excel-Import: Anwendung](./excel_import_anwendung.md)
- [Excel-Import: Pfleger](./excel_import_pfleger.md)
- [Übernahme eines Excel-Arbeitsblattes in eine private Variante](./uebernahme_eines_excel_arbeitsblattes_in_eine_private_varian/index.md)
