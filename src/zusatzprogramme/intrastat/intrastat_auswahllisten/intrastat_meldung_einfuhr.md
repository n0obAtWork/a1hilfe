...
<!-- source: https://amic.de/hilfe/intrastatvariante3.htm -->

Hauptmenü > Warenverkauf > Intrastat > Intrastat-Meldung > Variante 3: Intrastat-Meldung (Einfuhr)
...
| Kalenderjahr | |
| Monat | |
| Beteiligtes Land | Staat des zugehörigen Mandanten (Iso-Code aus dem Staatstamm)<br>Das für die Intrastatmeldung relevante Land.<br>Siehe auch:<br>[Staatstamm](../../../firmenstamm/staatstamm/index.md) |
...
| Suchen | Beschreibung |
| --- | --- |
| Einfuhr erzeugen (**F9**) | Erstellt die Intrastat Dateien, je nach Einstellungen der [Intrastat Einrichtung](./intrastat_einrichten.md) (XML/ASCII)<br>Der Export wird **nicht** nach den eingegeben Suchkriterien erstellt, sondern immer auf Basis aller Daten (eingegrenzt von Jahr & Periode) |
