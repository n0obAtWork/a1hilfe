...
<!-- source: https://amic.de/hilfe/_SPA_894.htm -->

Hier kann für verschiedene Bereiche in A.eins festgelegt werden, ob AdHoc-Updates gemacht werden sollen.

| Einstellung | Bedeutung |
| --- | --- |
| Artikel | Artikelbestände |
| Objekt | Partiebestände |
| Kontrakt | Kontraktbestände |
