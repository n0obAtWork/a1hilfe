...
<!-- source: https://amic.de/hilfe/streckenerfassungreporteinlade.htm -->
...
| --- | --- |
| Ueberschrift_Einladekontrolle | Kontrollauftrag Nr.: |
| an | an: |
| Bitte_Kontrolle | wir bitten um Einladekontrolle wie folgt: |
...
| Absprache2 | (Bitte sprechen Sie sich vorher mit der Ladestelle ab!) |
| Termin | Termin |
| BL_Datum | B/L Datum |
