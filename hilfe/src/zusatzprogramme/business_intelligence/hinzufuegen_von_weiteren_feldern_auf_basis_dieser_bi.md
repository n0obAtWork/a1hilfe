...
```sql
SELECT *,if v_klassnummer in (400,600,690,700,790,800,890) then 'Verkauf' else if v_klassnummer in (1400,1600,1690,1700,1790,1800,1890) then 'Einkauf' else 'Intern' endif endif as VkEk
