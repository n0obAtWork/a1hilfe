...
<!-- source: https://amic.de/hilfe/_lvs20_Inventur.htm -->
...
Alternativ kann man eine „**permanente Inventur**“ machen. Dabei werden einzelne Artikel(Artikelgruppen) zu einem Zeitpunkt gezählt, zu dem geringe Bestände und kaum Bewegung auf dem Artikel ist. Diese Art der Inventur ist gesetzlich auf bestimmte Artikelarten beschränkt und muss jeweils in einem engen zeitlichen Zusammenhang gezählt werden. Dieser Zeitraum wird in [SPA 1045 – Permanente Inventur](../../../firmenstamm/steuerparameter/optionen_warenwirtschaft/permanente_inventur_mit_lvs_spa_1045.md) festgelegt.

<p class="siehe-auch">Siehe auch:</p>

- [Einrichtung](./einrichtung.md)
- [Auswahl der Artikel](./auswahl_der_artikel.md)
- [Durchführung](./durchfuehrung.md)
- [Auswertung / Buchung](./auswertung_buchung.md)
