...
<!-- source: https://amic.de/hilfe/auftrag.htm -->

Aufträge entstehen durch Neuerfassung oder Umwandlung aus Angeboten. Aufträge werden als Vorgang gespeichert, auf sie kann in Nachfolgevorgängen zugegriffen werden; die disponierte Menge wird verbucht; Wertbuchungen erfolgen nicht. A.eins stellt folgende Bearbeitungsfunktionen zur Verfügung:
...
| ***Sammel-Li aus Aufträgen*** | Umwandeln mehrerer Aufträge in einen Lieferschein |
| ***Sammel-Re aus Aufträgen*** | Umwandeln mehrerer Aufträge in eine Rechnung |
| ***Teildispo aus Aufträgen*** | Aufruf eines Auftrages zur Teildisposition |
| ***Rückauftrag erfassen*** | Ausbuchen eines Restauftrags |
...
- [Ladeschein zusammenstellen](./ladeschein_zusammenstellen.md)
