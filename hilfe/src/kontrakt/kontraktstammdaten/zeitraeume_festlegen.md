...
Ist die Option [Steuerungsparameter](../../firmenstamm/steuerparameter/kontraktwesen/ratierliche_einstellungen_spa_846.md) 846 „Ratierliche Einstellungen“ „Ktr-Anzeige Minusrest in Folgezeitraum“ mit dem Wert **Ja** eingestellt, so wird eine zusätzliche Spalte <strong>Rest></strong>0 dargestellt, die negative Restmengen oder Restwerte eines Zeitraums mit der des Folgezeitraums verrechnet und selbst mit dem Wert 0 darstellt. Die Einstellung der Option [Steuerungsparameter](../../firmenstamm/steuerparameter/kontraktwesen/ratierliche_einstellungen_spa_846.md) 846 „Ratierliche Einstellungen“ „Ktr-Anzeige Kumulierte Zeitraum-Reste“ mit dem Wert **Ja** stellt in einer weiteren Spalte den kumulierten Rest dar.
...
| Tender | Nur bei Mengen-Kontrakt der Kontraktklasse <em>Verkaufskontrakt Hedge (4)</em> oder *Einkaufskontrakt Hedge (14)*:<br>Tendermenge des Kontrakt-Zeitraums des Artikels im Kontrakt-Zeitraum. |
