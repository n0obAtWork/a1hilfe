...
| Sound | Hier kann festgelegt werden, **welcher Typ von Sound bei bestimmten Aktionen abgespielt werden darf**. Es stehen folgende Optionen zur Verfügung:<br>• **Datalogic** – Gilt ausschließlich für **Datalogic-Geräte**.<br>• **Andere** – Für **nicht-Datalogic-Geräte** mit **Windows CE**.<br>• **Aus** – **Deaktiviert** die Soundausgabe vollständig.<br>• **Wave** – Ermöglicht das **Abspielen von WAV-Dateien**, die sich im **Anwendungsverzeichnis auf dem Scanner** befinden müssen.<br> |
