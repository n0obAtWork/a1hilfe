...
- Als nächstes unter **[OSQL]** den Control-String „^jpl FutterAppEinrichter“ ausführen.
  - Die Ordnerstruktur unter dem im Steuerparameter 1047 angegebenen Pfad wird angelegt.
  - Es werden die Exportprofile für den *„DbExporter“,* in der Tabelle „H_GS_EXPORT_PROFIL“ angelegt.
  - Es werden die Transferprofile für den *„A.eins.FtpTransfer“*, in der Tabelle „H_GS_TRANSFER_FTP“ angelegt.
  - Es wird die Batch-Datei „FutterAppExporter.bat“ in der Ordnerstruktur (SPA 1047) erstellt.
  - Übergabeparameter A.eins.FtpTransfer.exe: “CONNECTION=Mandantname TRANSFERID=TransferId“ aus Tabelle H_GS_TRANSFER_FTP
