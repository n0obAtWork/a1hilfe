...
<!-- source: https://amic.de/hilfe/_prozess_allgemein.htm -->

| Feld | Bedeutung |
| --- | --- |
| Belegerzeugung ohne Abschließen möglich | Mit diesem Schalter kann eingestellt werden, ob ein Vorgang ohne [Abschließen](../funktionen_auf_der_waagenmaske/wiegungen_abschliessen.md) erzeugt werden kann. Das [Abschließen](../funktionen_auf_der_waagenmaske/wiegungen_abschliessen.md) der Wiegung wird automatisch durchgeführt. |
| Lagernummer des Profils | Hier kann das Lager für das Profil eingestellt werden. Dieses Lager wird auch für die Siloauswahl herangezogen. Dieses Lager wird zur Vorbelegung des Lagers der Waage genommen. Aber wenn nur dann, wenn der Schalter Festen Wert erzwingen auf Ja steht |
