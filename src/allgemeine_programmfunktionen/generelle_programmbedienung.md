...
<p class="just-emphasize bottom-closer-together">Wie gelangt man in den Direktsprung-Dialog?</p>
...
<p class="just-emphasize bottom-closer-together">Funktionen im Direktsprung-Dialog</p>

Beim Direktsprung-Dialog handelt es sich um eine Dialog-Maske, die nur ein Eingabefeld enthält.

![Direksprung](image8_0.png "Direksprung")
...
![Direksprünge](image8_1.png "Direksprünge")

<p class="just-emphasize bottom-closer-together">Wo findet man die Direktsprung-kürzel</p>
...
![Beispiel - Direksprung in eckige Klammern](image8_2.png "Beispiel - Direksprung in eckige Klammern")
...
Mit der Maus, bei Markieren eines mit ![Pfeilspitze nach rechts](image8_4.png "Pfeilspitze nach rechts") gekennzeichnetem Feld wird das Untermenü angezeigt. (hier Stammdaten, Firma, Firmenkonstanten Filialstamm FLST)

Mit den Pfeiltasten rauf/runter innerhalb eines Menüs

Und mit rechts/links zu den Untermenüs, wenn ein ![Pfeilspitze nach rechts](image8_4.png "Pfeilspitze nach rechts") davor steht und zum nächsten Menü nur wenn kein ![Pfeilspitze nach rechts](image8_4.png "Pfeilspitze nach rechts") vor dem Menüpunkt steht.
...
![Sicherheitsabfrage](image8_5.png "Sicherheitsabfrage")
...
![Andere Form der Sicherheitsabfrage](image8_6.png "Andere Form der Sicherheitsabfrage")
...
![Anzeige zulässiger Alternativen nach fehlerhafter Eingabe](image8_7.png "Anzeige zulässiger Alternativen nach fehlerhafter Eingabe")
...
| **Strg+Ende** | <p>In der Auswahlliste wird in die letzte Zeile gesprungen.</p><p>In einem Stammdatenpfleger wird der letzte markierte Datensatz aufgerufen.</p> |
...
| **Strg+Pos1** | <p>In der Auswahlliste wird in die erste Zeile gesprungen.</p><p>In einem Stammdatenpfleger wird der erste markierte Datensatz aufgerufen.</p> |
...
| Icon | <p class="just-emphasize">Voraussetzung: Es wird die 64-Bit Version von A.eins benötigt.</p><p class="bottom-closer-together">Hier können die Icons von Funktionen auf der Auswahlliste 2.0 oder auf Masken mit einem Menü-Band geändert werden. Dazu wird in der Spalte „Indiv.“ unter der Überschrift „Icon“ die gewünschte Grafik ausgewählt. Mithilfe der F3-Taste erhält man hier einen Überblick über alle verfügbaren Icons. Neben der Bezeichnung wird hier auch die dazugehörige Grafik angezeigt:</p>![Icon](image8_9.png "Icon")<p>Verfügt eine Funktion standardmäßig über ein Icon, so ist in der Spalte „Std.“ der Name des Icons oder „System-Icon“ eingetragen. Diese Icons lassen sich für einfache Buttons ersetzen oder entfernen. Wird in der Spalte „Indiv.“ ein Icon ausgewählt, so wird das Standard-Icon mit dem ausgewählten Icon im Menü-Band ersetzt. Wird „_no_icon“ ausgewählt, so wird die Funktion aus dem Menüband entfernt und stattdessen dem „ausklappbaren“ Menü zugewiesen. Bei Menüs wie z.B. „Report drucken“, „Report bearbeiten“ oder „Word Serienbrief“ hat „_no_icon“ keine Auswirkung.</p><p>Hat eine Funktion standardmäßig kein Icon, so ist die Spalte „Std.“ zu der Funktion leer. Wird in der Spalte „Indiv.“ ein Icon eingetragen, so wird die Funktion mit der entsprechenden Grafik dem Menü-Band hinzugefügt. Dabei wird die Funktion aus dem „ausklappbaren“ Menü entfernt.</p><p>Um die Standardeinstellungen wiederherzustellen, ist der Eintrag aus dem Feld „Indiv.“ zu entfernen.</p><p class="just-emphasize">Beispiel:</p><p class="bottom-closer-together">In diesem Beispiel soll die Funktion ***Kontoauszug*** in der Anwendung **[ECL]** dem Menü-Band hinzugefügt werden.</p>![Menü-Band](image8_10.png "Menü-Band")<p class="bottom-closer-together">Um die Funktion dem Menü-Band hinzuzufügen, wird die Funktion ***Dieses Menü*** aufgerufen. In der Auswahlliste wird das entsprechende Funktionsmenü ausgewählt und die Funktion ***Private Sortierung/Tasten*** aufgerufen. In dem Feld „Indiv.“ unter dem Punkt „Icon“ wird in der Zeile mit der Funktion Kontoauszug die Grafik „printer“ ausgewählt.</p>![Private Sortierung](image8_11.png "Private Sortierung")<p class="bottom-closer-together">Die Anwendung **[ECL]** wird neugestartet. Die Funktion ***Kontoauszug*** erscheint jetzt im Menü-Band.</p>![Kontoauszug im Menü-Band](image8_12.png "Kontoauszug im Menü-Band") |

![Übersicht Private Sortierungen / Tasten](image8_13.png "Übersicht Private Sortierungen / Tasten")
