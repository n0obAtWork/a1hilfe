...
| --- | --- |
| Ueberschrift_LoeschKontrolle | Kontrollauftrag Nr.: |
| An | an: |
| Anrede | Sehr geehrte Damen und Herren, |
| Bitte_LoeschKontrolle | wir bitten um Löschkontrolle wie folgt: |
| Warenart | Warenart |
| Menge2 | Menge |
| Kontrollsatz | Kontrollsatz |
| Loeschstelle | Löschstelle |
| Absprache4 | (Bitte sprechen Sie sich vorher mit der Löschstelle ab!) |
| Termin | Termin |
| BL_Datum | B/L Datum |
