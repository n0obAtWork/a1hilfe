...
<!-- source: https://amic.de/hilfe/registerkarteallgemeininzollau.htm -->

Bei der Registerkarte „Allgemein“ handelt es sich um das Fenster zur Eingabe für die Ausfuhr erforderlichen Grunddaten. Beim ersten Öffnen können bereits Felder vorbelegt sein. Die Vorbelegung erfolgt durch die beim Anschriftstamm (Funktion „Zollausfuhrdaten“) vordefinierten Werte für eine Adresse. Hier sind diese Daten bis zum Zeitpunkt der Versendung der Ausfuhr änderbar. Wurde die Ausfuhr versendet, werden sämtliche Eingabefelder gesperrt, um den Zustand bei Versendung beizubehalten.
...
| Rechnungspreis | Betrag des Lieferscheins der die Ausfuhranmeldung zugrunde liegt |
| Rohmasse (kg) | Brutto-Gewicht aller Positionen incl. Packungsgewichten der Ausfuhranmeldungen, die keine Leergutartikel sind (Artikelstamm.Artistamtyp ungleich 5) |
