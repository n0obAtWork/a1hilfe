...
| JVAR_SYSTEM_STATUS_DBSYSADMIN | 1 = Der Aeins-Anwender ist ein Datenbank-Administrator, 0 sonst.<br>Veraltet, ist immer 1. |
...
| JVAR_SYSTEM_STATUS_PID | Prozess-ID der Aeins-Instanz<br>(Taskmanager, Details, Spalte PID) |
...
| JVAR_SYSTEM_STATUS_TESTDATENBANK | Die JVar ist 1 wenn,<br>die Parameter „section“, „cmdline“ oder „database_connect“ das Wort “test” enthalten.<br>Wenn die Option „Test_Indikator“ eingerichtet ist, hat diese Vorrang.<br>Mit Hilfe des Parameters „TESTDBOFF“ kann die Erkennung umgangen werden. |
| JVAR_SYSTEM_STATUS_WINDOWSUSER | Windows-Login-User<br>Entspricht der Windows-System-Umgebungsvariable USERNAME. |
