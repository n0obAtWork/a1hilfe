...
<!-- source: https://amic.de/hilfe/streckenerfassungreportandienu.htm -->

(Im Speditionsgeschäft ist es die Mitteilung, dass die Ware angekommen ist und bereitgehalten wird.)
...
| --- | --- |
| Ueberschrift_Andienung | Andienung |
| Kontrakt | Kontrakt |
| vom | vom |
| via | via |
| an | an: |
