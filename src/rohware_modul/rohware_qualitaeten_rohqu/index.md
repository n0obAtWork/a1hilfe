...
Darüber hinaus steht Ihnen die Möglichkeit zur Verfügung, einen Mittelwert aus gewählten Qualitäten zu bilden, und diesen als neuen Qualitätsdatensatz festzulegen.

<p class="siehe-auch">Siehe auch:</p>

- [Die Erfassungsmaske](./die_erfassungsmaske/index.md)
- [Technischer Hintergrund](./technischer_hintergrund/index.md)
