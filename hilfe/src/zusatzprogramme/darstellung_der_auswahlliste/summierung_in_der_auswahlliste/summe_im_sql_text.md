...
```text
FIELD Betrag,ZahlVorBetrag,N2,20,SUM=(ZahlVorBetrag*(3-Zahlvorsollhaben*2))
```
...
```text
FIELD Betrag,ZahlVorBetrag,N2,20,SUM=(ZahlVorBetrag*(3-Zahlvorsollhaben*2)),SUMFORMAT=S2
```
