...
| BelegversandMakro | Hier kann ein Makro (auch C#-Makro Typ Druck-Makro) hinterlegt werden. Dies hat zwei Einsprungpunkte: VOR oder Nach dem Belegversand.<br>Es bekommt drei Parameter übergeben:<br>• Fa_id - Die FA_ID des gedruckten Belegs<br>• FA_MndNr – FA_MndNr des gedruckten Beleges<br>• Before<br>• 1, wenn der Aufruf vor dem Belegversand erfolgt –<br>• 0 , wenn der Aufruf nach dem Belegversand erfolgt |
