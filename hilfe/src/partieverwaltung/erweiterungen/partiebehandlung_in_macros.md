...
```text
function StartPartieVerteilung( pos_handle: integer ) : integer;
```
...
```text
function AddPartieMenge( pos_handle: integer; partie_id: integer;
 Partie_artiposit: integer;
 menge: real; artikel_hinzufuegen : integer) : integer;
```
...
```text
function AddPartieMengeNummer( pos_handle: integer; partienummer
: integer;
 menge: real; artikel_hinzufuegen : integer) : integer;
```
...
```text
function EndPartieVerteilung(): integer;
```
