...
| Felder | Beschreibung |
| --- | --- |
| Bedienerklasse | Im Normalfall eine nicht-negative Zahl die Bediener gruppiert.  
Als Spezialfälle gibt es technische Bedienerklassen [Bedienerklasse: Defaultklasse](./standard_bedienerklassen.md). |
...
| Bedienerlisten-Info | Liste der zugehörigen Bediener.  
Angezeigt werden nur Bediener, die weder gelöscht oder gesperrt sind, und die in der Datenbank als User verzeichnet sind. |
