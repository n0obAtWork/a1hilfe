...
```sql
// Priv. SQL Text IB_SCANNER_ANZEIGE
...
SQL
     select TOP :TOP start at :ZEILENNUMMER ar.Lagernummer,ar.artikelid,
       ar.artikelbezeich from artikel ar
       join sekundschluessel sek on ( ar.artistammid = sek.sekudatenid
