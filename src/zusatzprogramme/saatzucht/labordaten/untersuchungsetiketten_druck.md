...
| Druckanzahl | In diesem Feld kann eingetragen werden, wie oft die Etiketten des jeweiligen Verfahrens ausgedruckt werden sollen.<br><strong>Achtung:</strong> <em>Im Verfahren kann unter Druckoptionen eine Anzahl von Kopien eingestellt werden. Ist die Druckanzahl größer als 1, so wird die Anzahl der Kopien jedes Etikett welches in dem Verfahren hinterlegt worden ist mit der Druckanzahl multipliziert.</em><br>Beispiel:<br>Druckanzahl = 2<br>Kopie eines Etiketts = 2<br>Es werden dann 4 Etiketten ausgedruckt.<br> |
