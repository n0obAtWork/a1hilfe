...
<!-- source: https://amic.de/hilfe/_produktionmodul.htm -->

Unter Produktion wird die Buchung (Menge und Wert) von Komponente zu Produkt nach der körperlichen Durchführung verstanden. Jedes Artikelkonto kann hierbei sowohl Komponente wie Produkt sein (Bsp. Vormischung).  
Stückliste ist verkaufsbelegbezogene Auflösung von Zusammensetzungen. Hierbei sind inhaltlich zu unterscheiden:
...
- [Einrichtungen](./einrichtungen/index.md)
- [Erfassung Produktion](./erfassung_produktion/index.md)
- [Produktion Schnellerfassung](./produktion_schnellerfassung.md)
- [Erfassung Stückliste](./erfassung_stueckliste/index.md)
