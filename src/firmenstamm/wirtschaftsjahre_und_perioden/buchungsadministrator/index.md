...
<details>
  ...
  > [!TIP]
  > Wenn man Bediener bei der Neuanlage nicht immer wieder neu eingeben möchte, so kann man mit der Funktion ***Speichern unter*** einen bereits bestehenden Datensatz als Vorlage nehmen.
</details>
...
- [Buchungsadministratoren: Pfleger](pfleger.md)