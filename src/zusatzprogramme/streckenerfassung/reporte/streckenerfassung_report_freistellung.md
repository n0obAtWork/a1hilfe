...
<!-- source: https://amic.de/hilfe/streckenerfassungreportfreiste.htm -->
...
| --- | --- |
| Ueberschrift_Freistellung | Freistellung |
| An | an: |
| Kontrakt_Nr | Kontrakt Nr.: |
| via | via |
| | mt |
| Anrede | Sehr geehrte Damen und Herren, |
| Info_Freistellung | gegen oben genannten Kontrakt stellen wir wie folgt zur Abnahme frei: |
| circa | ca. |
| Termin | Termin |
| Beladeort | Beladeort |
| Bemerkungen | Bemerkungen (wird ausgeblendet, wenn in den Streckentexten nichts eingegeben wurde) |
| Nummer_Abholung | Bei Abholung bitte folgende Nummer angeben: |
| Avisieren | Bitte vor Abholung rechtzeitig avisieren |
| Sitz1 | Sitz1 |
| Sitz2 | Sitz2 |
